...
def save_training_curves_log_2d(history, filename):
    ...
    axes[0, 1].set_title("L2 error: u (x_disp, log scale)")
    axes[0, 1].set_xlabel("Epoch")
    axes[0, 1].set_ylabel("L2_u")
    axes[0, 1].grid(True, which="both", alpha=0.3)

    axes[1, 0].plot(epochs, L2_v, "g-")
    axes[1, 0].set_yscale("log")
    axes[1, 0].set_title("L2 error: v (y_disp, log scale)")
    axes[1, 0].set_xlabel("Epoch")
    axes[1, 0].set_ylabel("L2_v")
    axes[1, 0].grid(True, which="both", alpha=0.3)

    axes[1, 1].plot(epochs, L2_s, "r-")
    axes[1, 1].set_yscale("log")
    axes[1, 1].set_title("L2 error: σ_vM (log scale)")
...
def save_training_curves_2d(history, filename):
    if len(history["epoch"]) == 0:
        return
    ...
    axes[1, 0].plot(epochs, L2_v, "g-")
    axes[1, 0].set_title("L2 error: v (y_disp)")
    axes[1, 0].set_xlabel("Epoch")
    axes[1, 0].set_ylabel("L2_v")
